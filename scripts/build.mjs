...
const posthogKey = process.env.LAZYKIMICODE_POSTHOG_API_KEY;
if (!posthogKey) {
  console.warn('Warning: LAZYKIMICODE_POSTHOG_API_KEY not set. Telemetry will be skipped in this build.');
}
